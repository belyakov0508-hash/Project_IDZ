...
def main():
    ...
    analyzer = AccessAnalyzer(file_path=raw_data_file, all_available_resources=reference_resources)
    # try:
...
# -----
    ...
    # Проверка восстановления — новый объект из сохранённых настроек
    print("Проверка восстановления настроек из файла...")
    new_analyzer = AccessAnalyzer()
    new_analyzer.load_state_from_file(state_file)
    print(f"Настройки восстановлены. Путь к данным: {new_analyzer.file_path}")
